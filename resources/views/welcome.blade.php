...
<head>
    ...
    <meta name="description"
        content="API.AERO é uma ferramenta destinada a facilitar a vida de quem está desenvolvendo aplicações
    para o setor aéreo">
                ...
                <header class="z-30 flex items-center w-full h-24 sm:h-24">
                    <div class="container flex items-center justify-between px-6 mx-auto">
                        ...
                        <div class="flex items-center">
                            <nav class="items-center hidden text-md uppercase font-sen lg:flex">
                ...
                <div class="z-20 flex items-center  dark:bg-gray-800">
                    <div class="container relative flex px-6 pt-10 pb-16 mx-auto">
                        ...
                        <div class="relative hidden sm:block sm:w-1/3 lg:w-3/5">
                            <img src="{{ url('storage/logos/logo-apiaero.png') }}"
